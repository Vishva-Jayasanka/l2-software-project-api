module.exports = {
    recoveryEmailTemplate: function(firstName, lastName, username, email, link, token) {
        return `
        <table
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="padding: 10px 10px 0 10px">
                                <h3 style="margin-bottom: 0">Hi ${firstName},</h3>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 10px">
                                <p style="margin-top: 0">
                                    We noticed you used this email as the recovery email of Information Management System FIT @ UoM, If its you please follow the link
                                    bellow to verify its you.
                                </p>
                                <div style="width: 100%; text-align: center; margin: 10px 0 10px 0">
                                    <a href="http://ec2-13-233-98-120.ap-south-1.compute.amazonaws.com:4200/#/auth/${link};token=${token};email=${email}">
                                ...
                                <p style="margin-top: 0">
                                    If you did not try to change your recovery email, please secure your account.
                                </p>
                            </td>
                        </tr>
